...
import { LayoutDashboard, Package, ClipboardList, LogOut, Store, User } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 gradient-hero border-b border-sidebar-border shadow-elevated">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-2 text-sm text-sidebar-foreground/80">
